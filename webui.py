...
title = f'draw arabic {fooocus_version.version}'
                    ...
                    with gr.Tab(label='Inpaint or Outpaint', id='inpaint_tab') as inpaint_tab:
                        with gr.Row():
                            with gr.Column():
                                ...
                                inpaint_additional_prompt = gr.Textbox(placeholder="صف ما تريد إعادة رسمه.", elem_id='inpaint_additional_prompt', label='إعادة الرسم بتوجيه إضافي', visible=False)
